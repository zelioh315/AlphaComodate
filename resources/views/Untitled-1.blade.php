          ...
          <div id="accordion">
            {{-- <div class="card"> --}}
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                  <form  name="myForm" method="get"  novalidate="novalidate" onsubmit="return validateForm()" action="{{url('/properties/{radius}/{lng}/{lat}')}}">
                    {{-- <div class="card bg-light mb-3" style="max-width: 100rem; height: 30rem;" > --}}
                      ...
                      <div class="form-row align-items-center">
                        <div class="col-md-10 offset-md-1">
                          ...
                          <input type="hidden" id="bedrooms" name="bedrooms" value="Any"/>
                          <input type="hidden" id="property_type" name="property_type" value="show all"/>
                          <input type="hidden" id="radius" name="radius" value="Any"/>
